...
\end{center}
\caption{The attentions scores for the VPCs corresponding to code in Listing \ref{fig:single_examples_code}, for each of our Code2Vec models. It is interesting that Path B implies that our argument \mintinline[]{python}{colors} is involved in a list comprehension and is highly weighted by most models.   }
