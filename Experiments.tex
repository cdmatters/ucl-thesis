...
We ran the standard tokenizations of the input name, and ran our Rote Learner baseline 50 times on this data, to calculate the average and standard deviations of the BLEU score. 
We then ran series of basic Seq-to-Seq architectures, starting from a basic seq-to-seq, then adding attention, a bidirectional encoder, and dropout. 
...
Since we now had discriminating information such as function name, and other argument names in our input, we used the Unsplit 1 Combined Dataset, as referred to in section A, and we tokenized as accord to section X.
