...
\end{figure}
    \footnotetext{Image sourced from https://en.wikipedia.org/wiki/Recurrent\_neural\_network}
...
\end{figure}
\footnotetext{Image sourced from http://colah.github.io/posts/2015-08-Understanding-LSTMs/}
